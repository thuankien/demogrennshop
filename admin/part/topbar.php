    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="index.php">
                ...
                <!-- <img width="100px" class="img-fluid" src="../../assets/images/logo.png" alt="Theme-Logo" /> -->
            </a>
        ...
        <div class="navbar-container container-fluid">
            <ul class="nav-left">
                <li>
                    <div class="sidebar_toggle"><a href="#"><i class="ti-menu"></i></a>
                    </div>
                </li>
            ...
            <ul class="nav-right">
                ...
                <li class="user-profile header-notification">
                    ...
                    <ul class="show-notification profile-notification">
                        ...
                        <li>
                            <a href="index.php?control=logout">
